...
fprintf('SpeakerCal_tdtinit: ...starting TDT hardware...\n');
...
PA5L = PA5init('GB', 1);
PA5R = PA5init('GB', 2);
% This is legacy = will only work with hardware devices with at least
% 3 analog inputs. for current RZ6 in RosenLab, this is not the case!
if cal.CheckCal
	iodev.REF = 3;
else
	iodev.REF = 0;
